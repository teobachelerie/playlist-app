...
function TrackList({
  ...
  return (
    <div className="h-full flex flex-col bg-base">
      <div
        className="shrink-0 z-10 bg-base flex items-center justify-between px-5 pt-6 pb-3"
      ...
      {tracks.length === 0 ? (
        ...
        <div
          ...
          style={{
            maskImage: "linear-gradient(to bottom, transparent, black 16px, black calc(100% - 24px), transparent)",
            WebkitMaskImage:
